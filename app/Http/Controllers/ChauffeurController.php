...
class ChauffeurController extends Controller
{
    ...
    {        
        ...
        $trajet->start = 0;
        $trajet->update();
        toastr()->warning('Trajet terminée ! ', 'Succès !');
  ...
  if($trajet->client_id!=null)
  {
    ...
    $trajet->started= 1;
    $trajet->update();
    toastr()->warning('Trajet Demarré ! ', 'Succès !');
    return (redirect()->route('chauffeurs.index'));
  }else{
    toastr()->error("Ce trajet n'as pas de client ! ", 'Attention !');
    return (redirect()->route('chauffeurs.index'));
    ...
    public function update(Request $request, string $id)
    {
        ...
        $trajet->update();
        toastr()->success('Trajet attribué  ! ', 'Succès !');
