...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="back min-h-screen bg-gray-100 dark:bg-gray-900"   >
            @include('layouts.navigation')

            <!-- Page Heading -->
            @if (isset($header))
                <header class="front dark:bg-gray-800 shadow">
                    <div class="back max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8" >
                        {{ $header }}
                    </div>
                </header>
            @endif
